...
double findMedianSortedArrays(vector<int> &nums1, vector<int> &nums2)
{
    ...
    while (low <= high)
    {
        ...
        {
            // checking whether the summed up array is even or odd
        ...
        // else if our condition doesn't satisfies because our left1>right2
        ...
        {
            // else if left2<right1 then we increase the value of low by 1
